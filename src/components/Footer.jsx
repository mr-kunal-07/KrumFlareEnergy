    ...
    <footer className="bg-black text-white py-8 px-6 md:px-16">
      ...
      <div className="mt-10 border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a href="#" className="text-orange-500 hover:text-white"><FaFacebookF /></a>
          <a href="#" className="text-orange-500 hover:text-white"><FaTwitter /></a>
          <a href="#" className="text-orange-500 hover:text-white"><FaInstagram /></a>
